...
const appRoutes: Routes = [
  ...
  {
    path: "kanban",
    loadChildren: () => import("./main/view/kanban/kanban.module").then((m) => m.KanbanModule),
    canActivate: [AuthGuard],
  },
  { path: "board", loadChildren: () => import("./main/view/dashboard/dashboard.module").then((m) => m.DashboardModule), canActivate: [AuthGuard] },
  {
    path: "",
    redirectTo: "/board",
    pathMatch: "full",
...
@NgModule({
  declarations: [AppComponent, ContextMenuComponent, BasicCustomContextMenuComponent, AnimatedCustomContextMenuComponent, SubMenuCustomContextMenuComponent],
  imports: [
    BrowserModule,
